...
```{r load, include=TRUE, results='asis', echo=FALSE}
...
**Removing Duplicates**
```{r cleanduplicates, include=TRUE, results='asis', echo=FALSE}
wine <- unique(wine)
xkablesummary(wine)
```
...
**Removing NA Values**
```{r removeNA, include=TRUE, results='asis', echo=FALSE}
wine <- na.omit(wine)
# str(wine)
xkablesummary(wine)
```
...
```{r quality , include=TRUE, results='asis', echo=FALSE}
...
```{r univariate1, include=TRUE, results='asis', echo=FALSE}
...
```{r univariate2, include=TRUE, results='asis', echo=FALSE}
...
```{r subsetting, include=TRUE, results='asis', echo=FALSE}
...
```{r alcqual, results='asis', echo=FALSE}
library(ggplot2)
...
```{r colalc,results='asis', echo=FALSE}
library(ggplot2)
...
```{r anovaredalc,results='asis', echo=FALSE}
...
```{r anovawhitealc,results='markup', echo=FALSE}
...
```{r density, results='asis',echo=FALSE }
library(ggplot2)
...
```{r densityt,results='asis', echo=FALSE}
...
```{r denqual, results='asis', echo=FALSE}
...
```{r anovaredden,results='markup', echo=FALSE}
...
```{r anovawhiteden,results='asis', echo=FALSE}
...
```{r chlorides, results='asis', echo=FALSE}
...
```{r chloridet,results='asis', echo=FALSE}
...
```{r chloralcohol, results='asis', echo=FALSE}
...
```{r anovaredchloride,results='asis',echo=FALSE}
...
```{r anovawhitechloride,results='asis', echo=FALSE}
...
```{r citric, results='asis', echo=FALSE}
library(ggplot2)
...
```{r citrict,results='asis', echo=FALSE}
...
```{r citricqual, results='asis', echo=FALSE}
...
```{r anovaredCITRIC,results='asis', echo=FALSE}
...
```{r anovawhitecitric,results='asis', echo=FALSE}
...
```{r multi, results='asis', echo=FALSE}
library(ggplot2)
